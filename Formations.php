...
<body>
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Team Building</h2>
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Developement Personel</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Formations Techniques</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <img src="images/arrow-left.png" />
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Animateurs</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <img src="images/arrow-left.png" />
