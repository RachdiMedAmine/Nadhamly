...
$sql2 = "SELECT * FROM `articles` WHERE categorie = '{$article['categorie']}' AND id != '$id_article' AND id_frs != '$id_userr' LIMIT 4";
  ...
  <section class="container sproduct">
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-6 col-md-12 col-12">
        ...
        <form action="ajout_au_panier_input.php" method="post">
          <input class="quantite" type="number" name="quantite" value="1"> <!-- Add name attribute for quantity input -->
