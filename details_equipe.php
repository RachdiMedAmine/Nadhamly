...
$sql4 = "select * from `utilisateur` where id_user='{$row['id_frs']}'";
...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <p><b>Dirigeant:</b> <?php echo $row4['nom'] . " " . $row4['prenom']; ?></p>
          <p><b>Catégorie:</b> <?php echo $row['categorie']; ?></p>
          <p><b>Description:</b></p>
          <p><?php echo $row['description']; ?></p>
          <div style="justify-content: space-between;" class="row">
            <form action="ajout_au_panier_equipe.php?id=<?php echo $id_equipe; ?>" method="post">
              <!-- Your form inputs here -->
              <input type="hidden" name="id" value="<?php echo $id_equipe; ?>">
              <!-- Other form elements -->
  ...
  <section id="featured" class="my-5 pb-5">
    ...
    <div class="container text-center mt-5 pb-5">
      ...
      <h3>Personnels:</h3>
      <hr class="mx-auto">
      <p>Equipe composée de:<?php if ($res2->num_rows == 0) {
    ...
    <div class="row mx-auto container-fluid">
      ...
      while ($row = mysqli_fetch_assoc($res2)) {
        ...
        if ($res3->num_rows > 0) {
          $user_data = $res3->fetch_assoc();
      ?>
          <div class="product text-center col-lg-3 col-md-4 col-12">
            <div class="card">
              <img class="card-img-top" src="images/default/image_default.png" alt="">
              <div class="card-body">
                <h5 class="card-title"><?php echo $user_data['nom'] . " " . $user_data['prenom'] ?></h5>
                <a href="profile_details.php?id=<?php echo $user_data['id_user'] ?>" style="text-decoration:none;"> <button>Voir détails</button></a>
              </div>
            </div>
          </div>
