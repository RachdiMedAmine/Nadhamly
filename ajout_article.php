...
$image3 = htmlspecialchars($image3);
  ...
  elseif (empty(trim($desc))) {
    ...
    elseif ($image2_size>2000000) {
      ...
      $insert=mysqli_query($conn, "INSERT INTO `articles` (id, libelle, description, nombre, prix, image1, image2, image3, categorie,motif, id_frs) values ('$id','$libelle','$desc','$qte','$prix','$image1','$image2','$image3','$cat','$motif','$id_frs')") or die('requête échouée');
      ...
      if ($insert) {
        ...
        $_SESSION['success_message'] = 'Ajout avec succés!';
...
<nav class="navbar navbar-expand-lg bg-transparent">
     ...
     <section class="container">
      ...
      <p>Veuillez indiquer tous les détails concernant l'article que vous voulez mettre en location via ce formulaire!</p>
      <form action="#" class="form" method="post" enctype="multipart/form-data">
        <div class="input-box">
          <label>libelle</label>
          <input type="text" placeholder="Entrer le libellé de l'article" name="libelle"  />
        </div>
        
      
        <div class="input-box">
          <label>Quantité disponible</label>
          <input type="text" placeholder="Entrer la quantité disponible" name="qte"  />
         
        </div>

          <div class="input-box">
            <label>Prix unitaire</label>
            <input type="text" placeholder="Entrer le prix unitaire"  name="prix"  />
        
          </div>
          <div class="input-box2">
            <label>Description</label>
            <textarea col="15" rows="5"name="desc" placeholder="Entrer la description de l'article"></textarea>
        ...
        <div class="cat-box">
          ...
          <div class="cat-option">
            <div class="cat">
              <input type="radio" id="meuble" name="cat" value="meuble" checked />
              <label for="meuble">Meuble</label>
            </div>
            <div class="cat">
              <input type="radio" id="equipement" name="cat" value="Equipement"  />
              <label for="equipement">Equipement</label>
            </div>
            <div class="cat">
              <input type="radio" id="espace" name="cat" value="Espace"  />
        ...
        <div class="cat-box">
          ...
          <div class="cat-option">
            <div class="cat">
              <input type="radio" id="vente" name="motif" value="Vente" checked />
              <label for="vente">Vente</label>
            </div>
            <div class="cat">
              <input type="radio" id="location" name="motif" value="Location"  />
    ...
    <footer class="bg-dark pt-5 pb-4">
      <div class="container-fluid">
          <div class="row  text-white">
              <div class="col-md-3 col-lg-3 col-sm-1 mx-auto mt-3"><h2 style="font-family:'Times New Roman', Times, serif;font-weight: 500;">A propos</h2></div>
              <div class="col-md-3 col-lg-3 col-sm-1 mx-auto mt-3"><h2 style="font-family: 'Times New Roman', Times, serif;font-weight: 500;">Accés Rapide</h2></div>
              <div class="col-md-3 col-lg-3 col-sm-1 mx-auto mt-3"><h2 style="font-family: 'Times New Roman', Times, serif;font-weight: 500;">Contactez-Nous</h2></div>
          </div>
          <div class="row greytext">
              <div class="col-md-3 col-lg-3 col-sm-1 mx-auto mt-3"><p style="font-family:'Times New Roman', Times, serif;"> Nadhamly est un projet crée afin de faciliter l'organisation des évènements il offre une plateforme unique, rapide et facile à utiliser aux utilisateurs qui aspirent à planifier tous les aspects de leurs propres évènements en une seule place et même aux fournisseurs qui cherchent une vitrine pour présenter leurs services et produits. Ceci permettra aux utilisateurs de maximiser leur gain de temps et profiter pleinement de chaque moment spécial.
              </p></div>
              <div class="col-md-3 col-lg-3 col-sm-1 mx-auto mt-3">   <ul>
