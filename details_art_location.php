  ...
  <section class="container sproduct">
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-6 col-md-12 col-12">
        ...
        <form action="ajout_au_panier_calendrier_lesdeux.php" method="post" id="addToCartForm">
          ...
          <input class="quantite" type="number" value="1" name="quantite">
        ...
        <div class="product text-center col-lg-3 col-md-4 col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="details_art_location.php?id=<?php echo $row['id']; ?>" style="text-decoration:none;"> <button class="btn btn-primary buy-btn">voir détails</button></a>
            </div>
          </div>
        </div>
