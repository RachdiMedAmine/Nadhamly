...
<head>
  ...
  <style>
    ...
    .card-body {
      ...
      height: 100%; /* Ensure card body fills the entire height */
    }
  </style>
    <style>
    .fa-cart-shopping {
...
<!--fin partie pour les petites images-->
      ...
      <div class="col-lg-6 col-md-12 col-12">
       ...
       <h4><?php echo"Fournisseur: ".$fournisseur['nom']." ".$fournisseur['prenom'];?></h4>
        ...
        <form action="ajout_au_panier_calendrier.php" method="post" id="addToCartForm">
          ...
          <button type="submit" class="buy-btn"><i class="ri-shopping-cart-fill"></i>Ajouter au panier</button>
        </form>   
        <!--fin form pour ajouter au panier-->   
      ...
      <div class="product text-center col-lg-3 col-md-4 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="<?php if ($row['nombre'] == 1 && $row['motif'] == 'Vente') { 
    echo 'details_art_vente_1.php?id=' . $row['id']; 
} elseif ($row['nombre'] > 1 && $row['motif'] == 'Vente') { 
    echo 'details_art_vente.php?id=' . $row['id']; 
} elseif ($row['nombre'] == 1 && $row['motif'] == 'Location') { 
    echo 'details_art_location_1.php?id=' . $row['id']; 
} else { 
    echo 'details_art_location.php?id=' . $row['id']; 
} ?>" style="text-decoration:none;">
    <button class="btn btn-primary buy-btn">voir détails</button>
</a>
          </div>
        </div>
      </div>
