...
<body class="vh 100">
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Equipements</h2>
      ...
      <div class="media-scroller snaps-inline container-fluid mr-1.2 md-1.2 " id="media-scroller-1">
        ...
        while ($row = mysqli_fetch_assoc($all_article)) {
          if ($row['categorie'] == 'Equipement') {
            ...
            ?>
            <div class="media-element hidden" <?php if ($row['nombre'] == 1 && $row['motif'] == 'Vente') { ?>onclick="window.location.href='details_art_vente_1.php?id=<?php echo $row['id']; ?>';" <?php } elseif (($row['nombre'] > 1 && $row['motif'] == 'Vente')) {
...
.mybtn:focus {
    ...
    <div class="col text-center hidden">
      <a href="voirtous.php" class="mybtn">Voir tous</a>
    </div>
  </div>
  </div>
  </div>
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Personnel</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <p style="color:black;"><i class="fa-solid fa-arrow-left"></i></p>
      ...
      <?php
            ...
            ?>
              <div class="media-element hidden"  onclick="window.location.href='details_equipe.php?id=<?php echo $row2['id']; ?>';" >
                <img src="images/upload/equipes/<?php echo $row2['image']; ?>" alt="">
                <?php
                  if($row0["role"] == "admin") {
                      echo '
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Espaces</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <p style="color:black;"><i class="fa-solid fa-arrow-left"></i></p>
        ...
        while ($row = mysqli_fetch_assoc($all_article)) {
          if ($row['categorie'] == 'Service') {
            ...
            <div class="media-element hidden" <?php if ($row['nombre'] == 1 && $row['motif'] == 'Vente') { ?>onclick="window.location.href='details_art_vente_1.php?id=<?php echo $row['id']; ?>';" <?php } elseif (($row['nombre'] > 1 && $row['motif'] == 'Vente')) {
              ...
              <img src="images/upload/articles/<?php echo $row['image1']; ?>" alt="chaises">
              <p class="title"><?php echo $row['libelle']; ?></p>
              <p class="title"><?php echo $row['prix']; ?></p>
            </div>
          <?php }
        }
        mysqli_data_seek($all_article, 0); ?>
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Formations</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <p style="color:black;"><i class="fa-solid fa-arrow-left"></i></p>
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Meubles</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <p style="color:black;"><i class="fa-solid fa-arrow-left"></i></p>
  ...
  <div class="partie-container">
    <h2 class="section-title hidden">Autres</h2>
    <div class="all-container">
      <div class="scroller-button-container hidden">
        <button class="scroll-left-button" data-target="media-scroller-1">
          <p style="color:black;"><i class="fa-solid fa-arrow-left"></i></p>
    ...
    <div class="col text-center hidden mb-5">
      <a href="voirtous.php" class="mybtn">Voir tous</a>
    </div>
  </div>
