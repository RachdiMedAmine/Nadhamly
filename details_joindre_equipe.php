    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <p><b>Dirigeant:</b> <?php echo $row['id_frs']; ?></p>
          ...
          <a style="text-decoration:none;" href="joindre_equipe.php?id=<?php echo $row['id']; ?>"><button><i class="ri-user-add-fill"></i> Rejoindre l'équipe</button></a>
          ...
          <div class="product text-center col-lg-3 col-md-4 col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="details-art.php?id=<?php echo $user_data['id_user'] ?>" style="text-decoration:none;"> <button>Voir détails</button></a>
              </div>
            </div>
          </div>
