...
if (isset($_POST['submit'])) {
  ...
  if (empty(trim($libelle))) {
    ...
    $update = mysqli_query($conn, "update `equipes` set libelle='$libelle', description='$desc', prix='$prix', categorie='$cat', dispo='$dispo', image='$image1' where id='$id_equipe'; ") or die('requête échouée');
    ...
    if ($update) {
      ...
      $_SESSION['success_message'] = 'Modification de l\'équipe avec succés!';
    } else {
      $message4 = 'Echec de la modification!';
      echo "<div class='alert alert-danger' style=' padding: 5px 5px;
        border: 1px solid transparent;
        border-radius: .25rem;'>";
      echo $message4;
...
<head>
  ...
  <title>Mise à jour de l'équipe</title>
  <style>
    .fa-cart-shopping {
      font-size: 24px;
...
<body>
  ...
  <section class="container">
    ...
    <p>Veuillez modifier tous les détails concernant votre équipe via ce formulaire!</p>
    <form action="#" class="form" method="post" enctype="multipart/form-data">

      <img src="images/upload/equipes/<?php echo $image1 ?>" id="imageDisplay" style="
  ...
  border-radius: 50%;" onClick="triggerClick()" />
      ...
      <div class="input-box">
        <label>libelle</label>
        <input type="text" placeholder="Entrer le libellé de l'équipe" name="libelle" value="<?php echo $libelle ?>" />
      </div>


      <div class="input-box">
        <label>Prix</label>
        <input type="text" placeholder="Entrer le prix " name="prix" value="<?php echo $prix ?>" />

      </div>
      <div class="input-box2">
        <label>Description</label>
        <textarea col="15" rows="5" name="desc" placeholder="Entrer la description de votre équipe"><?php echo $desc ?></textarea>
      ...
      <div class="cat-box">
        ...
        <div class="cat-option">
          <div class="cat">
            <input type="radio" id="sécurité" name="cat" value="sécurité" <?php echo ($cat == 'sécurité') ? 'checked' : ''; ?> />
          ...
          <div class="cat">
            <input type="radio" id="restauration" name="cat" value="restauration" <?php echo ($cat == 'restauration') ? 'checked' : ''; ?> />
            <label for="restauration">Restauration</label>
          </div>
          <div class="cat">
            <input type="radio" id="musique" name="cat" value="musique" <?php echo ($cat == 'musique') ? 'checked' : ''; ?> />
          ...
          <div class="cat">
            <input type="radio" id="entretien" name="cat" value="entretien" <?php echo ($cat == 'entretien') ? 'checked' : ''; ?> />
      ...
      <h3>Vous souhaitez ne plus afficher cette équipes aux autres utilisateurs? </h3>
      <div class="cat-option">
        <div class="cat">
          <input type="radio" id="oui" name="dispo" value=0 <?php echo ($dispo == 0) ? 'checked' : ''; ?> />
          <label for="oui">Oui</label>
        </div>
        <div class="cat">
          <input type="radio" id="non" name="dispo" value=1 <?php echo ($dispo == 1) ? 'checked' : ''; ?> />
